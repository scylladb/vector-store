...
| `VECTOR_STORE_CDC_WIDE_SAFETY_INTERVAL`    | Wide-framed CDC reader's safety interval. The value is in human readable value (ie. `30s`)                               | `30s`             |
| `VECTOR_STORE_CDC_WIDE_SLEEP_INTERVAL`     | Wide-framed CDC reader's sleep interval. The value is in human readable value (ie. `10s`)                                | `10s`             |
