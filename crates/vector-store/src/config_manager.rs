...
impl ConfigManager {
    /// Create a new ConfigManager and return it along with a receiver
    ...
    /// Note: vector_store_addr and opensearch_addr checks are now handled by their
    /// respective actors (httpserver and opensearch).
