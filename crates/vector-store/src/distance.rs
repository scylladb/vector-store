    ...
    fn try_from(
        ...
        match space_type {
            ...
            SpaceType::Hamming => {
                ...
                let n_bits = dimensions.0.get().div_ceil(8) * 8;
                anyhow::ensure!(
                    value <= n_bits as f32,
...
mod tests {
    ...
    fn test_euclidean_distance_validation() {
        ...
        assert!(Distance::new_euclidean(18.0).is_ok());
    ...
    fn test_cosine_distance_validation() {
        ...
        assert!(Distance::new_cosine(18.0).is_err());
    ...
    fn test_dot_product_distance_validation() {
        ...
        assert!(Distance::new_dot_product(18.0).is_ok());
    ...
    fn test_hamming_distance_validation() {
        ...
        assert!(Distance::new_hamming(5.0, dimensions).is_ok());
        assert!(Distance::new_hamming(18.0, dimensions).is_err()); // 18 > dimensions
